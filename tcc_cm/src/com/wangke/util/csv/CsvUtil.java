...
public class CsvUtil {
     ...
     * 文件读入
     */
    public void read(String fileName, List list, SOConverter converter, int numFirst) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            list.add(converter.string2object(line));
        }
    }
